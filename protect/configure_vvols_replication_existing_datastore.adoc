...
* Cuando configure una máquina virtual para habilitar la replicación para un almacén de datos existente, asegúrese de verificar el volumen FlexVol que tiene una configuración vVols.
