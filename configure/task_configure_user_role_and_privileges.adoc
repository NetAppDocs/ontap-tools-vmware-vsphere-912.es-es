...
* Debe haber descargado el archivo de privilegios de ONTAP de las herramientas de ONTAP mediante \https://{virtual_appliance_IP}:9083/vsc/config/VSC_ONTAP_User_Privileges.zip.
+
