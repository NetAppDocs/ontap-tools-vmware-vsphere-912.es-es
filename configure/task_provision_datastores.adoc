...
Puede seleccionar el tipo *nfs*, *VMFS* o *vvols* para configurar un almacén de datos.
Cuando selecciona el tipo vVols, el protocolo NVMe/FC se vuelve disponible.
...
+
Puede seleccionar
La opción *Distribuir datos de almacén de datos a través del
Clúster de ONTAP* para aprovisionar un volumen de FlexGroup
sistema de almacenamiento. Seleccionando esta opción
Deselecciona automáticamente la casilla de verificación *Usar almacenamiento
Perfil de capacidad para el aprovisionamiento*.
...
NOTE: Si el proveedor de VASA está habilitado, el usuario
puede elegir usar la capacidad de almacenamiento
perfiles.
